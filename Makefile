...
auxdir	= ./SDL-1.2.15/build-scripts
distpath = $(srcdir)/..
distdir = SDL-1.2.15
...
SHELL	= /bin/sh
CC      = gcc
INCLUDE = -Iinclude -I./SDL-1.2.15/include
CFLAGS  = -g -O2 
EXTRA_CFLAGS = -Iinclude -I./SDL-1.2.15/include -D_GNU_SOURCE=1 -fvisibility=hidden    -D_REENTRANT     -DXTHREADS -I/usr/include/directfb -D_REENTRANT -D_REENTRANT -DHAVE_LINUX_VERSION_H -Wall
LDFLAGS = 
...
TARGET  = libSDL.la
SOURCES =  ./SDL-1.2.15/src/*.c ./SDL-1.2.15/src/audio/*.c ./SDL-1.2.15/src/cdrom/*.c ./SDL-1.2.15/src/cpuinfo/*.c ./SDL-1.2.15/src/events/*.c ./SDL-1.2.15/src/file/*.c ./SDL-1.2.15/src/stdlib/*.c ./SDL-1.2.15/src/thread/*.c ./SDL-1.2.15/src/timer/*.c ./SDL-1.2.15/src/video/*.c ./SDL-1.2.15/src/joystick/*.c ./SDL-1.2.15/src/video/dummy/*.c ./SDL-1.2.15/src/audio/disk/*.c ./SDL-1.2.15/src/audio/dummy/*.c ./SDL-1.2.15/src/loadso/dlopen/*.c ./SDL-1.2.15/src/audio/dsp/*.c ./SDL-1.2.15/src/audio/dma/*.c ./SDL-1.2.15/src/audio/alsa/*.c ./SDL-1.2.15/src/audio/esd/*.c ./SDL-1.2.15/src/audio/pulse/*.c ./SDL-1.2.15/src/audio/nas/*.c ./SDL-1.2.15/src/video/x11/*.c ./SDL-1.2.15/src/video/Xext/Xxf86dga/*.c ./SDL-1.2.15/src/video/dga/*.c ./SDL-1.2.15/src/video/Xext/Xxf86vm/*.c ./SDL-1.2.15/src/video/Xext/Xv/*.c ./SDL-1.2.15/src/video/Xext/Xinerama/*.c ./SDL-1.2.15/src/video/Xext/XME/*.c ./SDL-1.2.15/src/video/fbcon/*.c ./SDL-1.2.15/src/video/directfb/*.c ./SDL-1.2.15/src/thread/pthread/SDL_systhread.c ./SDL-1.2.15/src/thread/pthread/SDL_syssem.c ./SDL-1.2.15/src/thread/pthread/SDL_sysmutex.c ./SDL-1.2.15/src/thread/pthread/SDL_syscond.c ./SDL-1.2.15/src/joystick/linux/*.c ./SDL-1.2.15/src/cdrom/linux/*.c ./SDL-1.2.15/src/timer/unix/*.c
OBJECTS = $(objects)/SDL.lo $(objects)/SDL_error.lo $(objects)/SDL_fatal.lo $(objects)/SDL_audio.lo $(objects)/SDL_audiocvt.lo $(objects)/SDL_audiodev.lo $(objects)/SDL_mixer.lo $(objects)/SDL_mixer_MMX.lo $(objects)/SDL_mixer_MMX_VC.lo $(objects)/SDL_mixer_m68k.lo $(objects)/SDL_wave.lo $(objects)/SDL_cdrom.lo $(objects)/SDL_cpuinfo.lo $(objects)/SDL_active.lo $(objects)/SDL_events.lo $(objects)/SDL_expose.lo $(objects)/SDL_keyboard.lo $(objects)/SDL_mouse.lo $(objects)/SDL_quit.lo $(objects)/SDL_resize.lo $(objects)/SDL_rwops.lo $(objects)/SDL_getenv.lo $(objects)/SDL_iconv.lo $(objects)/SDL_malloc.lo $(objects)/SDL_qsort.lo $(objects)/SDL_stdlib.lo $(objects)/SDL_string.lo $(objects)/SDL_thread.lo $(objects)/SDL_timer.lo $(objects)/SDL_RLEaccel.lo $(objects)/SDL_blit.lo $(objects)/SDL_blit_0.lo $(objects)/SDL_blit_1.lo $(objects)/SDL_blit_A.lo $(objects)/SDL_blit_N.lo $(objects)/SDL_bmp.lo $(objects)/SDL_cursor.lo $(objects)/SDL_gamma.lo $(objects)/SDL_pixels.lo $(objects)/SDL_stretch.lo $(objects)/SDL_surface.lo $(objects)/SDL_video.lo $(objects)/SDL_yuv.lo $(objects)/SDL_yuv_mmx.lo $(objects)/SDL_yuv_sw.lo $(objects)/SDL_joystick.lo $(objects)/SDL_nullevents.lo $(objects)/SDL_nullmouse.lo $(objects)/SDL_nullvideo.lo $(objects)/SDL_diskaudio.lo $(objects)/SDL_dummyaudio.lo $(objects)/SDL_sysloadso.lo $(objects)/SDL_dspaudio.lo $(objects)/SDL_dmaaudio.lo $(objects)/SDL_alsa_audio.lo $(objects)/SDL_esdaudio.lo $(objects)/SDL_pulseaudio.lo $(objects)/SDL_nasaudio.lo $(objects)/SDL_x11dga.lo $(objects)/SDL_x11dyn.lo $(objects)/SDL_x11events.lo $(objects)/SDL_x11gamma.lo $(objects)/SDL_x11gl.lo $(objects)/SDL_x11image.lo $(objects)/SDL_x11modes.lo $(objects)/SDL_x11mouse.lo $(objects)/SDL_x11video.lo $(objects)/SDL_x11wm.lo $(objects)/SDL_x11yuv.lo $(objects)/XF86DGA.lo $(objects)/XF86DGA2.lo $(objects)/SDL_dgaevents.lo $(objects)/SDL_dgamouse.lo $(objects)/SDL_dgavideo.lo $(objects)/XF86VMode.lo $(objects)/Xv.lo $(objects)/Xinerama.lo $(objects)/xme.lo $(objects)/SDL_fb3dfx.lo $(objects)/SDL_fbelo.lo $(objects)/SDL_fbevents.lo $(objects)/SDL_fbmatrox.lo $(objects)/SDL_fbmouse.lo $(objects)/SDL_fbriva.lo $(objects)/SDL_fbvideo.lo $(objects)/SDL_DirectFB_events.lo $(objects)/SDL_DirectFB_video.lo $(objects)/SDL_DirectFB_yuv.lo $(objects)/SDL_systhread.lo $(objects)/SDL_syssem.lo $(objects)/SDL_sysmutex.lo $(objects)/SDL_syscond.lo $(objects)/SDL_sysjoystick.lo $(objects)/SDL_syscdrom.lo $(objects)/SDL_systimer.lo

SDLMAIN_TARGET = libSDLmain.la
SDLMAIN_SOURCES = ./SDL-1.2.15/src/main/dummy/*.c
